            ...
            <div>
                ...
                <CardGroup className="card-container">
                    <Card className="main-card p-4 round">
                        ...
                        <Card.Body>
                            <Card.Title className="fs-3 text-black fw-bold">Landing Page</Card.Title>
                    ...
                    <Card className="main-card p-4 round">
                        ...
                        <Card.Body>
                            <Card.Title  className="fs-3 text-black fw-bold">Web Design</Card.Title>
                            <Card.Text  className="fs-5 text-justify">
                    ...
                    <Card className="main-card p-4 round">
                        ...
                        <Card.Body>
                            <Card.Title  className="fs-3 text-black fw-bold">Web Development</Card.Title>
                            <Card.Text  className="fs-5 text-justify">
                    ...
                    <Card className="main-card p-4 round">
                        ...
                        <Card.Body>
                            <Card.Title  className="fs-3 text-black fw-bold">UI Design</Card.Title>
                            <Card.Text  className="fs-5 text-justify">
                    ...
                    <Card className="main-card p-4 round">
                        ...
                        <Card.Body>
                            <Card.Title  className="fs-3 text-black fw-bold">Website Speed Optimise</Card.Title>
                            <Card.Text  className="fs-5 text-justify">
                    ...
                    <Card className="main-card p-4 round">
                        ...
                        <Card.Body>
                            <Card.Title  className="fs-3 text-black fw-bold">Consultancy and support</Card.Title>
                            <Card.Text  className="fs-5 text-justify">
