      ...
      <div className='contact-container'>
        <div className='contact-details lh-lg'>
          ...
          <div>
            ...
            <h2>Phone</h2>
            <a className='call-number text-light' href='tel:01764896633'>
              +8801764896633
            </a>
          </div>
          <div className='mb-5'>
        ...
        <Form
          className='contact-form p-5 lh-lg gap-3'
          ref={form}
          onSubmit={sendEmail}
        >
          ...
          <button type='submit' value='Send' className='primary-btn mt-4'>
            Submit
          </button>
        </Form>
        {/* Form end here */}
